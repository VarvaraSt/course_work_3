...
from PyQt5.QtWidgets import QApplication, QMainWindow, QGridLayout, QWidget, QTableWidget, QTableWidgetItem, \
    QFileDialog, QDialog, QGraphicsScene, QGraphicsView, QCheckBox, QHBoxLayout, QHeaderView
...
import ui.createNet_ui as createNet_ui
import ui.drawNet_ui as drawNet_ui
import ui.exception_ui as exception_ui
...
class mainWindow(QtWidgets.QMainWindow, main_ui.Ui_MainWindow):
    ...
    def count(self):
        ...
        model.y = pe.Var(model.A, bounds=(0.0, None), doc='Flow')
    ...
    def updateTables(self):
        ...
        self.tableWidget_2.setVerticalHeaderLabels(
            map(str, [connection for connection in self.E if connection[0] < connection[1]]))
